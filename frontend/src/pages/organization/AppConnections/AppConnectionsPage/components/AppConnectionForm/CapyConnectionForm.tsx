...
import {
  ...
  TCapyConnection
} from "@app/hooks/api/appConnections/types/capy-connection";
...
export const CapyConnectionForm = ({ appConnection, onSubmit }: Props) => {
              ...
              <FieldLabel htmlFor="instance-url">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    Will default to Capy Cloud if not specified.
                  </TooltipContent>
                </Tooltip>
              </FieldLabel>
              <Input
                id="instance-url"
                placeholder="https://api.capy.ai"
                value={value || ""}
            ...
            <Field className="mb-4">
              <FieldLabel htmlFor="method">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    ...
                    {APP_CONNECTION_MAP[AppConnection.Capy].name}. This field cannot be changed
                    after creation.
                  </TooltipContent>
                </Tooltip>
              </FieldLabel>
              <Select disabled={isUpdate} value={value} onValueChange={(val) => onChange(val)}>
                ...
                <SelectContent position="popper">
                  {Object.values(CapyConnectionMethod).map((method) => {
                    return (
